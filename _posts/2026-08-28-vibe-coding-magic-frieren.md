---
layout: post
title: "Vibe coding is like magic in Frieren"
date: 2026-08-28
description: "The ability to realize positive impact with coding agents is a function of your ability to visualize it... Exactly like the magic system in Frieren..."
...
In Frieren, there's a scene where Ubel talks about being able to cut anything she is able to *visualize*, but not being able to cut anything she isn't able to visualize. To me, high-quality visualization means not just simply "imagining that something happens", but rather imagining *in extremely granular detail* what something should look like if it were to happen. I imagine the skill of a mage in the Frieren world would be correlated with their exact ability to visualize how spells get realized. In other words, **the more detail in which you can visualize something, the stronger your ability to realize it.**

![Übel's magic explained : r/Frieren](https://preview.redd.it/%C3%BCbels-magic-explained-v0-xqmm9ax69okc1.png?width=640&crop=smart&auto=webp&s=412fd6f397f3603a46f2c188b220b749b4cb4bbf)

![Übel's magic explained : r/Frieren](https://i.redd.it/%C3%BCbels-magic-explained-v0-vnduy3089okc1.png?width=1117&format=png&auto=webp&s=4c23141065fa54ee33513e53ea598dc71c151081)

## Coding agents' ability to realize is determined by the user's ability to visualize

There is a weird parallel of this visualization = realization idea to writing code with a coding agent. Everybody has access to coding agents nowadays, but the impact delivered by people using them is highly variable. There are cases where coding agents amplify impact 2x, 10x, 100x, yet also at the same time there are cases where the generated code is complete vibe-coded slop. There also seems to be highly varying opinions about the capabilities of coding agents, where some people claim the agents are dumb and completely unable to do anything useful, and others who claim they haven't manually written a line of code in months.
